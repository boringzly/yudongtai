...
class Backbone_VSSM(VSSM):
    def __init__(self, in_chans, out_indices=(0, 1, 2, 3), pretrained=None, norm_layer="ln", **kwargs):
        kwargs.update(norm_layer=norm_layer)
        super().__init__(in_chans=in_chans, **kwargs)
