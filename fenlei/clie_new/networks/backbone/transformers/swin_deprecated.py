...
"""
This implementation of SwinTransformer is replaced with beckbone_sseg """
...
# from .backbone.backbone_ssseg import FFN 
...
#         x = x.transpose(1, 2).contiguous()  # B, H/2*W/2, 4*C
...
#             Defaults: 0.
#         dropout_rate (dict, optional): The dropout_rate used before output.
...
#             # for concat
#             #state_dict['patch_embed.proj.weight'] = torch.cat((state_dict['patch_embed.proj.weight'], state_dict['patch_embed.proj.weight']), 1)
...
#             projection_weight = state_dict["patch_embed.projection.weight"]
#             for i in range(3, self.band_num):
#                 projection_weight = torch.cat(
#                     (projection_weight, projection_weight[:, (i % 3) : (i % 3 + 1), :, :]), 1
#                 )
#             state_dict["patch_embed.projection.weight"] = projection_weight
