...
from networks.nestedUnet import Deep_NestedUNet_U2, Deep_SeNestedUNet
...
def GenerateNet(cfg):
	if cfg.MODEL_NAME == 'unet':
	...
	elif cfg.MODEL_NAME == 'res_unet_FAPN':
		return res_unet_FAPN(cfg.MODEL_BACKBONE, cfg.PRE_TRAINED, cfg.MODEL_OUTPUT_STRIDE,cfg.BAND_NUM, cfg.MODEL_NUM_CLASSES)
	...
	elif cfg.MODEL_NAME == 'Deep_SeNestedUNet':
		return Deep_SeNestedUNet(cfg.MODEL_BACKBONE, cfg.PRE_TRAINED, cfg.BAND_NUM, cfg.MODEL_NUM_CLASSES)
	...
	elif cfg.MODEL_NAME == 'SwinUNet_MSTD':
		return SwinUNet_MSTD(cfg.MODEL_BACKBONE, cfg.PRE_TRAINED, cfg.BAND_NUM, cfg.MODEL_NUM_CLASSES)
	elif cfg.MODEL_NAME == 'SwinUNet_MSTD_NDVI_NDWI':
		return SwinUNet_MSTD_NDVI_NDWI(cfg.MODEL_BACKBONE, cfg.PRE_TRAINED, cfg.BAND_NUM, cfg.MODEL_NUM_CLASSES)
		...
		raise ValueError(f'GenerateNet.py: network {cfg.MODEL_NAME} is not support yet')
