...
def run_class_prediction():
    ...
    input_path1 = '/siwei3/data2/pre_image_dev/2024'
    #input_path2 = '/siwei3/data2/inner_data/13/252/ecomn_2024_13_252.tif'
    #input_path2 = '/siwei3/data2/inner_data/13/252/standard/GF1D_PMS_E111.5_N23.0_20240805_L4D1257459224.tiff'
    #input_path2 = '/docker/tmp/class_output1/GF1D_PMS_E111.5_N23.0_20240805_L4D1257459224.tiff'
    #input_path2 = '/siwei3/data2/inner_data/13/168/standard/GF1C_PMS_E116.3_N23.5_20240321_L4D1022226249.tiff'
    input_path2 = '/cresdashare/docker/tmp/ecomn_2025_27_599.tif'
    mask_path = '/siwei3/data2/workflow/output/test/e1921928eaa799f5ed87b2d2d1281449/eaa94965dc9347fc9a6921293592b427e19219/output_path606560138.shp'
    output_path = '/siwei3/data2/inner_data/27/599/ecomn_2025_27_599.shp'
...
if __name__ == '__main__':
    ...
    try:
        WSGIServer(('localhost', 5003), app).serve_forever()
